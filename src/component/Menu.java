...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenu(EventMenu event) {
        this.event = event;
        addMenu("1", "الواجهة", 0);
        addMenu("2", "إضافة مداخيل", 1);
        addMenu("3", "إضافة مخاريج", 2);
        addMenu("4", "طاقم العمال", 3);
       addMenu("5", "خروج", 4);
       // addMenu("5", "Setting", 4);
    }
    ...
    private void initComponents() {
        ...
        imageAvatar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/admin.jpg"))); // NOI18N
